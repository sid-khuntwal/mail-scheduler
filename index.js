...
app.get("/auth", async (req, res) => {
    ...
    async function main() {
        ...
        // Repeat the following steps in random intervals of 45-120 seconds
        setInterval(async () => {
            // Get messages that have no prior replies
        ...
        }, Math.floor(Math.random() * (120 - 45 + 1) + 45) * 1000); // Random interval between 45-120 seconds
    }
...
app.listen(port, () => {
    console.log(`Mail Scheduler listening at http://localhost:${port}`);
});
